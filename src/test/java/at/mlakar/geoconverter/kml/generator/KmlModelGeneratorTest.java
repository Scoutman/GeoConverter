...
public class KmlModelGeneratorTest
{
	...
	{
		Assert.assertEquals(3, mKml.getDocument().getPlacemarkList().size());
	}
	...
	public void coordinateTest()
	{
		...
		Assert.assertEquals(new Double(47.362176), mKml.getDocument().getPlacemarkList().get(0).getGeometry().getCoordinates().getCoordinateList().get(0).getLat());
		Assert.assertEquals(new Double(15.423645), mKml.getDocument().getPlacemarkList().get(0).getGeometry().getCoordinates().getCoordinateList().get(0).getLon());
		Assert.assertEquals(1720, mKml.getDocument().getPlacemarkList().get(0).getGeometry().getCoordinates().getCoordinateList().get(0).getAltitude());
	}
