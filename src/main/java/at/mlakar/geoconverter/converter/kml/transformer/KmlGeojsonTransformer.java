...
import at.mlakar.geoconverter.converter.kml.model.MLineString;
...
public class KmlGeojsonTransformer implements KmlGeojsonTransformerInterface
{
	...
	@Override
	public MGeometry visitSingleGeometry(at.mlakar.geoconverter.converter.kml.model.MGeometry kmlGeometry)
	{
		MGeometry geojsonGeometry;
		MCoordinate geojsonCoordinates = null;

		if (kmlGeometry instanceof at.mlakar.geoconverter.converter.kml.model.MPoint)
		{
		...
		{
			geojsonGeometry = new MGeometry(new at.mlakar.geoconverter.converter.geojson.model.MLineString());
	...
	public MGeometry visitMultiGeometry(MMultiGeometry kmlMultiGeometry)
	{
		...
		MCoordinate geojsonCoordinates = null;
		at.mlakar.geoconverter.converter.kml.model.MGeometry kmlGeometry = kmlMultiGeometry.getGeometry().get(0);
	...
	public MCoordinate visitCoordinatesLineString(MCoordinatesList kmlCoordinates)
	{
		...
		for (at.mlakar.geoconverter.converter.kml.model.MCoordinate coordinate : kmlCoordinates.getCoordinateList())
		{
	...
	public MCoordinate visitCoordinatesMultiLinearRing(MMultiGeometry kmlMultiGeometry)
	{
		...
		for (at.mlakar.geoconverter.converter.kml.model.MGeometry kmlGeometry : kmlMultiGeometry.getGeometry())
		{
			MCoordinateList geojsonCoordinateListL3 = new MCoordinateList();
			MCoordinateList geojsonCoordinateListL4 = new MCoordinateList();

			for (at.mlakar.geoconverter.converter.kml.model.MCoordinate kmlCoordinate : kmlGeometry.getCoordinates().getCoordinateList())
			{
